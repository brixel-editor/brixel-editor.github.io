...
function defineArduinoBlocks() {
    ...
    const blockDefinitionsPart2 = [
        ...
        // 9. ===============================================================함수 카테고리
        // ❌ procedures_ifreturn, procedures_ifreturn_void 블록 제거됨
        // (Blockly core에 이미 내장되어 있어 중복 정의 불가)
    ];
    ...
    const blockDefinitionsPart4 = [
        ...
        {
            "type": "ht16k33_pixel",
            "message0": Blockly.Msg.BKY_HT16_PIXEL || "Dot Matrix %1 Pixel Row(0-7) %2 Col(0-7) %3 %4",
            "args0": [
                { "type": "input_value", "name": "NUM", "check": "Number" },
                { "type": "input_value", "name": "ROW", "check": "Number" },
                { "type": "input_value", "name": "COL", "check": "Number" },
        ...
        },
        {
            ...
            "message0": Blockly.Msg.BKY_HT16_BIPIX || "Bicolor Matrix %1 Pixel Row(0-7) %2 Col(0-7) %3 Color %4",
            "args0": [
                { "type": "input_value", "name": "NUM", "check": "Number" },
                { "type": "input_value", "name": "ROW", "check": "Number" },
                { "type": "input_value", "name": "COL", "check": "Number" },
        ...
        {
            "type": "ht16k33_line",
            "message0": Blockly.Msg.BKY_HT16_LINE || "Dot Matrix %1 Line R1(0-7) %2 C1(0-15) %3 R2(0-7) %4 C2(0-15) %5",
            "args0": [
                { "type": "input_value", "name": "NUM", "check": "Number" },
        ...
        {
            "type": "ht16k33_circle",
            "message0": Blockly.Msg.BKY_HT16_CIR || "Dot Matrix %1 Circle R(0-7) %2 C(0-15) %3 Radius %4",
            "args0": [
                { "type": "input_value", "name": "NUM", "check": "Number" },
                { "type": "input_value", "name": "R", "check": "Number" },
        ...
        {
            "type": "ht16k33_rect",
            "message0": Blockly.Msg.BKY_HT16_RECT || "Dot Matrix %1 Rect R(0-7) %2 C(0-15) %3 W %4 H %5 %6",
            "args0": [
                { "type": "input_value", "name": "NUM", "check": "Number" },
                { "type": "input_value", "name": "R", "check": "Number" },
                { "type": "input_value", "name": "C", "check": "Number" },
    ...
    const blockDefinitionsPart9 = [
        ...
        {
            "type": "attach_servo",
            "message0": Blockly.Msg.BKY_ATTACH_SERVO || "Attach Servo Pin %1",
            "args0": [
                { "type": "input_value", "name": "PIN", "check": "Number" }
            ],
            "inputsInline": true,
            ...
            "nextStatement": null,
            "colour": "#6190DF",
            "tooltip": Blockly.Msg.BKY_ATTACH_SERVO_TOOLTIP || "Attach servo to pin"
        },

        // 2. 서보 연결 (최소/최대값 설정)
        {
            "type": "attach_servo_minmax",
            "message0": Blockly.Msg.BKY_ATTACH_SERVO_MINMAX || "Attach Servo Pin %1 Min %2 Max %3",
            "args0": [
                { "type": "input_value", "name": "PIN", "check": "Number" },
            ...
            "nextStatement": null,
            "colour": "#6190DF",
            "tooltip": Blockly.Msg.BKY_ATTACH_SERVO_MINMAX_TOOLTIP || "Attach servo with custom min/max pulse width"
        },

        // 3. 서보 분리
        {
            "type": "detach_servo",
            "message0": Blockly.Msg.BKY_DETACH_SERVO || "Detach Servo Pin %1",
            "args0": [
                { "type": "input_value", "name": "PIN", "check": "Number" }
            ],
            "inputsInline": true,
            ...
            "nextStatement": null,
            "colour": "#6190DF",
            "tooltip": Blockly.Msg.BKY_DETACH_SERVO_TOOLTIP || "Detach servo from pin"
        },

        // 4. 서보 각도 설정 - ❌ 중복 정의 제거됨 (Line 229에 이미 정의됨)

        // 5. 서보 마이크로초 설정
        {
            "type": "set_servo_microseconds",
            "message0": Blockly.Msg.BKY_SET_SERVO_MICROSECONDS || "Set Servo Pin %1 Microseconds %2",
            "args0": [
                { "type": "input_value", "name": "PIN", "check": "Number" },
            ...
            "nextStatement": null,
            "colour": "#6190DF",
            "tooltip": Blockly.Msg.BKY_SET_SERVO_MICROSECONDS_TOOLTIP || "Set servo pulse width (544-2400μs)"
        },

        // 6. 서보 각도 읽기
        {
            "type": "read_servo_angle",
            "message0": Blockly.Msg.BKY_READ_SERVO_ANGLE || "Read Servo Pin %1 Angle",
            "args0": [
                { "type": "input_value", "name": "PIN", "check": "Number" }
            ],
            "inputsInline": true,
            "output": "Number",
            "colour": "#6190DF",
            "tooltip": Blockly.Msg.BKY_READ_SERVO_ANGLE_TOOLTIP || "Read current servo angle (0-180)"
        },

        // 7. 서보 마이크로초 읽기
        {
            "type": "read_servo_microseconds",
            "message0": Blockly.Msg.BKY_READ_SERVO_MICROSECONDS || "Read Servo Pin %1 Microseconds",
            "args0": [
                { "type": "input_value", "name": "PIN", "check": "Number" }
            ],
            "inputsInline": true,
            "output": "Number",
            "colour": "#6190DF",
            "tooltip": Blockly.Msg.BKY_READ_SERVO_MICROSECONDS_TOOLTIP || "Read current pulse width in microseconds"
        },

        // 8. 서보 연결 상태 확인
        {
            "type": "is_servo_attached",
            "message0": Blockly.Msg.BKY_IS_SERVO_ATTACHED || "Is Servo Pin %1 Attached?",
            "args0": [
                { "type": "input_value", "name": "PIN", "check": "Number" }
            ],
            "inputsInline": true,
            "output": "Boolean",
            "colour": "#6190DF",
            "tooltip": Blockly.Msg.BKY_IS_SERVO_ATTACHED_TOOLTIP || "Check if servo is attached to pin"
        },

        // 9. [Geekservo] 360도 절대 각도 제어
        {
            "type": "geekservo_angle_360",
            "message0": Blockly.Msg.BKY_GEEKSERVO_ANGLE_360 || "Geekservo Pin %1 Set Angle %2 (0~360)",
            "args0": [
                { "type": "input_value", "name": "PIN", "check": "Number" },
                { "type": "input_value", "name": "ANGLE", "check": "Number" }
            ],
            ...
            "nextStatement": null,
            "colour": "#E67E22",
            "tooltip": Blockly.Msg.BKY_GEEKSERVO_ANGLE_360_TOOLTIP || "Geekservo 5KG Position Control (500-2500us)"
        },

        // 10. [Geekservo] 바퀴 모드
        {
            "type": "geekservo_wheel",
            "message0": Blockly.Msg.BKY_GEEKSERVO_WHEEL || "Geekservo Wheel Pin %1 Speed %2 Dir %3",
            "args0": [
                { "type": "input_value", "name": "PIN", "check": "Number" },
                { "type": "input_value", "name": "SPEED", "check": "Number" },
                {
                    ...
                    "name": "DIR",
                    "options": [
                        [Blockly.Msg.BKY_GEEKSERVO_CW || "Forward (CW)", "TRUE"],
                        [Blockly.Msg.BKY_GEEKSERVO_CCW || "Backward (CCW)", "FALSE"]
                    ]
                }
            ],
            "inputsInline": true,
            ...
            "nextStatement": null,
            "colour": "#E67E22",
            "tooltip": Blockly.Msg.BKY_GEEKSERVO_WHEEL_TOOLTIP || "Geekservo 5KG Motor Mode (3000-5000us)"
        },
    ...
    const blockDefinitionsPart12 = [
        ...
        // ================== 웹 BLE (Web BLE) ==================
        {
            "type": "sys_webble_setup",
            "message0": Blockly.Msg.BKY_WEBBLE_SETUP || "Web BLE Setup Name %1",
            "args0": [
            ...
            "nextStatement": null,
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WEBBLE_SETUP_TIP || "Initialize built-in BLE and set name (Scratch compatible)."
        },
        {
            "type": "sys_webble_available",
            "message0": Blockly.Msg.BKY_WEBBLE_AVAILABLE || "Is Web BLE message available?",
            "output": "Boolean",
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WEBBLE_AVAILABLE_TIP || "Check if data has been received via Web BLE."
        },
        {
            "type": "sys_webble_read",
            "message0": Blockly.Msg.BKY_WEBBLE_READ || "Message received via Web BLE",
            "output": "String",
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WEBBLE_READ_TIP || "Read data received via Web BLE."
        },
        {
            "type": "sys_webble_write",
            "message0": Blockly.Msg.BKY_WEBBLE_WRITE || "Send %1 via Web BLE",
            "args0": [
            ...
            "nextStatement": null,
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WEBBLE_WRITE_TIP || "Transmit data via Web BLE."
        },
        {
            "type": "sys_webble_connected",
            "message0": Blockly.Msg.BKY_WEBBLE_CONNECTED || "Is Web BLE connected?",
            "output": "Boolean",
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WEBBLE_CONNECTED_TIP || "Check Web BLE connection status."
        },
        {
            "type": "sys_webble_parse",
            "message0": Blockly.Msg.BKY_WEBBLE_PARSE || "Parse received Web BLE data by %1",
            "args0": [
            ...
            "nextStatement": null,
            "colour": "#5BA55C",
            "tooltip": Blockly.Msg.BKY_WEBBLE_PARSE_TIP || "Parse received data with a delimiter (e.g., comma) and store it."
        },
        {
            "type": "sys_webble_get_value",
            "message0": Blockly.Msg.BKY_WEBBLE_GET_VALUE || "%1-th parsed Web BLE value",
            "args0": [
            ...
            "output": "String",
            "colour": "#5BA55C",
            "tooltip": Blockly.Msg.BKY_WEBBLE_GET_VALUE_TIP || "Retrieve the value at the specified index from the parsed data as a string."
        },

        // ================== 1. 설정 ==================
        {
            "type": "sys_serial_begin",
            "message0": Blockly.Msg.BKY_SERIAL_BEGIN || "통신 시작 (RX:%1 TX:%2 속도:%3)",
            "args0": [
                { "type": "input_value", "name": "RX", "check": "Number" },
                { "type": "input_value", "name": "TX", "check": "Number" },
                { "type": "input_value", "name": "BAUD", "check": "Number" }
            ...
            "nextStatement": null,
            "colour": "#5B67A5",
            "tooltip": Blockly.Msg.BKY_SERIAL_BEGIN_TOOLTIP || "0,1번 핀은 하드웨어 시리얼, 그 외는 소프트웨어 시리얼 자동 설정"
        },
        {
            "type": "sys_serial_connected",
            "message0": Blockly.Msg.BKY_SERIAL_CONNECTED || "시리얼이 연결되었는가?",
            "output": "Boolean",
            "colour": "#5B67A5",
            "tooltip": Blockly.Msg.BKY_SERIAL_CONNECTED_TOOLTIP || "시리얼 연결 상태를 확인합니다."
        },

        // ================== 2. 송신 ==================
        {
            "type": "sys_serial_send_change",
            "message0": Blockly.Msg.BKY_SERIAL_SEND_CHANGE || "%1 값이 변했을 때만 보내기 (줄바꿈 포함)",
            "args0": [
                { "type": "input_value", "name": "CONTENT" }
            ],
            "inputsInline": true,
            ...
            "nextStatement": null,
            "colour": "#367E7F",
            "tooltip": Blockly.Msg.BKY_SERIAL_SEND_CHANGE_TOOLTIP || "이전 값과 다를 때만 전송합니다 (센서값 전송 최적화)"
        },
        {
            "type": "sys_serial_print",
            "message0": Blockly.Msg.BKY_SERIAL_PRINT || "%1 보내기 (줄바꿈 %2)",
            "args0": [
                { "type": "input_value", "name": "CONTENT" },
            ...
            "nextStatement": null,
            "colour": "#367E7F",
            "tooltip": Blockly.Msg.BKY_SERIAL_PRINT_TOOLTIP || "데이터를 시리얼로 전송합니다."
        },
        {
            "type": "sys_serial_print_continuous",
            "message0": Blockly.Msg.BKY_SERIAL_PRINT_CONTINUOUS || "%1 계속 보내기 (줄바꿈 %2)",
            "args0": [
                { "type": "input_value", "name": "CONTENT" },
                { "type": "field_checkbox", "name": "NEWLINE", "checked": true }
            ],
            ...
            "nextStatement": null,
            "colour": "#367E7F",
            "tooltip": Blockly.Msg.BKY_SERIAL_PRINT_CONTINUOUS_TOOLTIP || "매 루프마다 데이터를 계속 전송합니다."
        },
        {
            "type": "sys_serial_print_multi",
            "message0": Blockly.Msg.BKY_SERIAL_PRINT_MULTI || "📤CSV 보내기: %1",
            "args0": [
            ...
            "nextStatement": null,
            "colour": "#367E7F",
            "tooltip": Blockly.Msg.BKY_SERIAL_PRINT_MULTI_TOOLTIP || "문자열을 CSV 형태로 전송합니다."
        },
        {
            "type": "sys_serial_send_key_val",
            "message0": Blockly.Msg.BKY_SERIAL_SEND_KEY_VAL || "이름: %1 값: %2 보내기 (줄바꿈 %3)",
            "args0": [
            ...
            "nextStatement": null,
            "colour": "#367E7F",
            "tooltip": Blockly.Msg.BKY_SERIAL_SEND_KEY_VAL_TOOLTIP || "키:값 형태로 데이터를 전송합니다."
        },

        // ================== 3. 수신 ==================
        {
            "type": "sys_serial_poll",
            "message0": Blockly.Msg.BKY_SERIAL_POLL || "🔄 통신 데이터 수신대기 (Poll)",
            "previousStatement": null,
            "nextStatement": null,
            "colour": "#E67E22",
            "tooltip": Blockly.Msg.BKY_SERIAL_POLL_TOOLTIP || "Loop 함수 맨 위에 꼭 넣으세요! 논블로킹 수신의 핵심입니다."
        },
        {
            "type": "sys_serial_available",
            "message0": Blockly.Msg.BKY_SERIAL_AVAILABLE || "새로운 메시지가 있는가?",
            "output": "Boolean",
            "colour": "#E67E22",
            "tooltip": Blockly.Msg.BKY_SERIAL_AVAILABLE_TOOLTIP || "수신된 메시지가 있는지 확인합니다."
        },
        {
            "type": "sys_serial_read_raw",
            "message0": Blockly.Msg.BKY_SERIAL_READ_RAW || "수신된 데이터 (문장)",
            "output": "String",
            "colour": "#E67E22",
            "tooltip": Blockly.Msg.BKY_SERIAL_READ_RAW_TOOLTIP || "수신된 원본 데이터를 반환합니다."
        },
        {
            "type": "sys_serial_flush",
            "message0": Blockly.Msg.BKY_SERIAL_FLUSH || "수신된 데이터 지우기",
            "previousStatement": null,
            "nextStatement": null,
            "colour": "#E67E22",
            "tooltip": Blockly.Msg.BKY_SERIAL_FLUSH_TOOLTIP || "수신 버퍼를 비웁니다."
        },

        // ================== 4. 파싱 ==================
        {
            "type": "sys_serial_parse_delimiter",
            "message0": Blockly.Msg.BKY_SERIAL_PARSE_DELIMITER || "수신된 데이터를 %1 (으)로 분석하기",
            "args0": [
                { "type": "input_value", "name": "DELIMITER", "check": "String" }
            ],
            "inputsInline": true,
            ...
            "nextStatement": null,
            "colour": "#5BA55C",
            "tooltip": Blockly.Msg.BKY_SERIAL_PARSE_DELIMITER_TOOLTIP || "수신 데이터를 구분자로 파싱하여 내부 저장합니다."
        },
        {
            "type": "sys_parsed_value_get",
            "message0": Blockly.Msg.BKY_PARSED_VALUE_GET || "%1 번째 분석된 값",
            "args0": [
                { "type": "input_value", "name": "INDEX", "check": "Number" }
            ],
            "inputsInline": true,
            "output": "String",
            "colour": "#5BA55C",
            "tooltip": Blockly.Msg.BKY_PARSED_VALUE_GET_TOOLTIP || "마지막으로 분석된 데이터에서 N번째 값을 가져옵니다."
        },
        {
            "type": "sys_parsed_count",
            "message0": Blockly.Msg.BKY_PARSED_COUNT || "분석된 값의 개수",
            "output": "Number",
            "colour": "#5BA55C",
            "tooltip": Blockly.Msg.BKY_PARSED_COUNT_TOOLTIP || "마지막으로 분석된 데이터의 필드 개수를 반환합니다."
        },
        {
            "type": "sys_parse_csv_get",
            "message0": Blockly.Msg.BKY_PARSE_CSV_GET || "%1 번째 값 가져오기 (문장: %2)",
            "args0": [
                { "type": "input_value", "name": "INDEX", "check": "Number" },
            ...
            "output": "String",
            "colour": "#5BA55C",
            "tooltip": Blockly.Msg.BKY_PARSE_CSV_GET_TOOLTIP || "쉼표로 구분된 데이터에서 N번째 값을 추출합니다."
        },
        {
            "type": "sys_parse_count",
            "message0": Blockly.Msg.BKY_PARSE_COUNT || "분석된 값의 개수 (문장: %1)",
            "args0": [
                { "type": "input_value", "name": "STRING", "check": "String" }
            ],
            "inputsInline": true,
            "output": "Number",
            "colour": "#5BA55C",
            "tooltip": Blockly.Msg.BKY_PARSE_COUNT_TOOLTIP || "파싱된 데이터 필드의 개수를 반환합니다."
        },
        {
            "type": "sys_util_to_number",
            "message0": Blockly.Msg.BKY_UTIL_TO_NUMBER || "%1 을(를) 숫자로 변환",
            "args0": [
                { "type": "input_value", "name": "STRING" }
            ],
            "output": "Number",
            "colour": "#5BA55C",
            "tooltip": Blockly.Msg.BKY_UTIL_TO_NUMBER_TOOLTIP || "문자열을 숫자로 변환합니다."
        },
    ...
    // Part WiFi: WiFi (WebSocket) blocks - Scratch Compatible
    const blockDefinitionsPartWiFi = [
        {
            "type": "wifi_setup",
            "message0": Blockly.Msg.BKY_WIFI_SETUP || "Setup WiFi SSID %1 Password %2",
            "args0": [
            ...
            "nextStatement": null,
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WIFI_SETUP_TIP || "Connect to WiFi network."
        },
        {
            "type": "wifi_ws_server_setup",
            "message0": Blockly.Msg.BKY_WIFI_WS_SERVER_SETUP || "Start WebSocket Server Port %1",
            "args0": [
            ...
            "nextStatement": null,
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WIFI_WS_SERVER_SETUP_TIP || "Start a WebSocket server on the specified port."
        },
        {
            "type": "wifi_is_connected",
            "message0": Blockly.Msg.BKY_WIFI_IS_CONNECTED || "WiFi Connected?",
            "output": "Boolean",
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WIFI_IS_CONNECTED_TIP || "Check if WiFi is connected."
        },
        {
            "type": "wifi_local_ip",
            "message0": Blockly.Msg.BKY_WIFI_LOCAL_IP || "WiFi Local IP Address",
            "output": "String",
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WIFI_LOCAL_IP_TIP || "Returns the local IP address of the board."
        },
        {
            "type": "wifi_ws_available",
            "message0": Blockly.Msg.BKY_WIFI_WS_AVAILABLE || "WebSocket Message Available?",
            "output": "Boolean",
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WIFI_WS_AVAILABLE_TIP || "Check if a new WebSocket message has been received."
        },
        {
            "type": "wifi_ws_read",
            "message0": Blockly.Msg.BKY_WIFI_WS_READ || "Read WebSocket Message",
            "output": "String",
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WIFI_WS_READ_TIP || "Read the latest WebSocket message."
        },
        {
            "type": "wifi_ws_send",
            "message0": Blockly.Msg.BKY_WIFI_WS_SEND || "WebSocket Send %1 (with newline)",
            "args0": [
                { "type": "input_value", "name": "DATA", "check": ["String", "Number"] }
            ],
            "previousStatement": null,
            "nextStatement": null,
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WIFI_WS_SEND_TIP || "Send data via WebSocket followed by a newline."
        },
        {
            "type": "wifi_ws_send_raw",
            "message0": Blockly.Msg.BKY_WIFI_WS_SEND_RAW || "WebSocket Send %1 (Raw)",
            "args0": [
                { "type": "input_value", "name": "DATA", "check": ["String", "Number"] }
            ],
            "previousStatement": null,
            "nextStatement": null,
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WIFI_WS_SEND_RAW_TIP || "Send raw data via WebSocket without a newline."
        },
        {
            "type": "wifi_ws_send_label_value",
            "message0": Blockly.Msg.BKY_WIFI_WS_SEND_LABEL_VALUE || "WebSocket Send Label %1 Value %2",
            "args0": [
            ...
            "nextStatement": null,
            "colour": "#4285F4",
            "tooltip": Blockly.Msg.BKY_WIFI_WS_SEND_LABEL_VALUE_TIP || "Send data in 'LABEL:VALUE' format."
        }
    ];

    Blockly.common.defineBlocksWithJsonArray(blockDefinitionsPartWiFi);
...
/**
 * Unknown Block을 동적으로 생성하는 함수
 * 정의되지 않은 블록 타입을 대체하는 빨간색 경고 블록을 생성합니다.
 * @param {string} originalType - 원본 블록 타입명
 */
function createUnknownBlockPlaceholder(originalType) {
    // 이미 생성된 블록 타입이면 중복 생성하지 않음
    if (!Blockly.Blocks['unknown_block_placeholder_' + originalType]) {
        Blockly.Blocks['unknown_block_placeholder_' + originalType] = {
            init: function () {
                this.jsonInit({
                    "type": "unknown_block_placeholder_" + originalType,
                    "message0": "⚠️ 지원 중단: %1",
                    "args0": [{
                        "type": "field_label",
                        "name": "ORIGINAL_TYPE",
                    ...
                    "nextStatement": null,
                    "colour": "#E53935",  // 빨간색
                    "tooltip": "블록 타입 '" + originalType + "'은(는) 더 이상 지원되지 않습니다.\n이 블록을 제거하고 새로운 블록으로 교체하세요.",
                    "helpUrl": ""
                });

                // 경고 아이콘 추가
                this.setWarningText("이 블록은 더 이상 사용할 수 없습니다.");
            }
        };

        // 코드 생성기도 동적으로 추가 (빈 문자열 반환)
        if (typeof Arduino !== 'undefined' && Arduino.forBlock) {
            Arduino.forBlock['unknown_block_placeholder_' + originalType] = function (block, generator) {
                // Unknown block은 코드 생성 시 무시
                return '';
            };
        }

        console.log('[Unknown Block Placeholder 생성]', originalType);
    }
}

// ============================================================
// 블록 조립 기록/재생 블록 (UTIL 카테고리) - 다국어 지원 적용됨
// ============================================================

// 1. 블록조립 기록 시작
Blockly.Blocks['util_record_start'] = {
    init: function () {
        this.jsonInit({
            "type": "util_record_start",
            "message0": Blockly.Msg.BKY_UTIL_RECORD_START || "🔴 블록조립 기록 시작",
            "previousStatement": null,
            "nextStatement": null,
            "colour": "#08B89F",
            "tooltip": Blockly.Msg.BKY_UTIL_RECORD_START_TOOLTIP || "이 블록을 더블클릭하면 블록 조립 과정을 기록하기 시작합니다.",
            "helpUrl": ""
        });
    }
};
...
// 2. 블록조립 기록 중지
Blockly.Blocks['util_record_stop'] = {
    init: function () {
        this.jsonInit({
            "type": "util_record_stop",
            "message0": Blockly.Msg.BKY_UTIL_RECORD_STOP || "⏹️ 블록조립 기록 중지",
            "previousStatement": null,
            "nextStatement": null,
            "colour": "#08B89F",
            "tooltip": Blockly.Msg.BKY_UTIL_RECORD_STOP_TOOLTIP || "이 블록을 더블클릭하면 블록 조립 기록을 중지합니다.",
            "helpUrl": ""
        });
    }
};
...
// 3. 블록조립 과정 재생
Blockly.Blocks['util_record_play'] = {
    init: function () {
        this.jsonInit({
            "type": "util_record_play",
            "message0": Blockly.Msg.BKY_UTIL_RECORD_PLAY || "▶️ 블록조립 과정 재생 %1",
            "args0": [
                {
                    "type": "field_dropdown",
                    "name": "SPEED",
                    "options": [
                        [Blockly.Msg.BKY_SPEED_1X || "1배속", "1"],
                        [Blockly.Msg.BKY_SPEED_2X || "2배속", "2"],
                        [Blockly.Msg.BKY_SPEED_4X || "4배속", "4"],
                        [Blockly.Msg.BKY_SPEED_8X || "8배속", "8"]
                    ]
                }
            ],
            "previousStatement": null,
            "nextStatement": null,
            "colour": "#08B89F",
            "tooltip": Blockly.Msg.BKY_UTIL_RECORD_PLAY_TOOLTIP || "이 블록을 더블클릭하면 기록된 블록 조립 과정을 재생합니다. 재생 배속을 선택할 수 있습니다.",
            "helpUrl": ""
        });
    }
};
...
// 4. 블록조립 재생 중지
Blockly.Blocks['util_record_play_stop'] = {
    init: function () {
        this.jsonInit({
            "type": "util_record_play_stop",
            "message0": Blockly.Msg.BKY_UTIL_RECORD_PLAY_STOP || "⏹️ 블록조립 재생 중지",
            "previousStatement": null,
            "nextStatement": null,
            "colour": "#08B89F",
            "tooltip": Blockly.Msg.BKY_UTIL_RECORD_PLAY_STOP_TOOLTIP || "이 블록을 더블클릭하면 블록 조립 재생을 중지합니다.",
            "helpUrl": ""
        });
    }
};
...
// 5. 블록조립 기록 초기화
Blockly.Blocks['util_record_reset'] = {
    init: function () {
        this.jsonInit({
            "type": "util_record_reset",
            "message0": Blockly.Msg.BKY_UTIL_RECORD_RESET || "🔄 블록조립 기록 초기화",
            "previousStatement": null,
            "nextStatement": null,
            "colour": "#08B89F",
            "tooltip": Blockly.Msg.BKY_UTIL_RECORD_RESET_TOOLTIP || "이 블록을 더블클릭하면 블록 조립 기록을 모두 삭제합니다.",
            "helpUrl": ""
        });
    }
};
...
// 6. 기록 상태 (정보 블록)
Blockly.Blocks['util_record_status'] = {
    init: function () {
        this.jsonInit({
            "type": "util_record_status",
            "message0": Blockly.Msg.BKY_UTIL_RECORD_STATUS || "📊 기록 상태",
            "output": "String",
            "colour": "#08B89F",
            "tooltip": Blockly.Msg.BKY_UTIL_RECORD_STATUS_TOOLTIP || "현재 기록 상태를 반환합니다 (중지/기록 중/재생 중). 더블클릭하면 IDE 콘솔에 출력됩니다.",
            "helpUrl": ""
        });
    }
};
...
// 7. 이벤트 수 (정보 블록)
Blockly.Blocks['util_record_event_count'] = {
    init: function () {
        this.jsonInit({
            "type": "util_record_event_count",
            "message0": Blockly.Msg.BKY_UTIL_RECORD_EVENT_COUNT || "📊 이벤트 수",
            "output": "Number",
            "colour": "#08B89F",
            "tooltip": Blockly.Msg.BKY_UTIL_RECORD_EVENT_COUNT_TOOLTIP || "기록된 이벤트 개수를 반환합니다. 더블클릭하면 IDE 콘솔에 출력됩니다.",
            "helpUrl": ""
        });
    }
};
...
// 8. 총 블록조립 시간 (정보 블록)
Blockly.Blocks['util_record_duration'] = {
    init: function () {
        this.jsonInit({
            "type": "util_record_duration",
            "message0": Blockly.Msg.BKY_UTIL_RECORD_DURATION || "📊 총 블록조립 시간",
            "output": "String",
            "colour": "#08B89F",
            "tooltip": Blockly.Msg.BKY_UTIL_RECORD_DURATION_TOOLTIP || "블록 조립에 소요된 총 시간을 반환합니다. 더블클릭하면 IDE 콘솔에 출력됩니다.",
            "helpUrl": ""
        });
    }
};
...
// 9. 블록조립 시작시간 (정보 블록)
Blockly.Blocks['util_record_start_time'] = {
    init: function () {
        this.jsonInit({
            "type": "util_record_start_time",
            "message0": Blockly.Msg.BKY_UTIL_RECORD_START_TIME || "📊 블록조립 시작시간",
            "output": "String",
            "colour": "#08B89F",
            "tooltip": Blockly.Msg.BKY_UTIL_RECORD_START_TIME_TOOLTIP || "블록 조립을 시작한 시간을 반환합니다. 더블클릭하면 IDE 콘솔에 출력됩니다.",
            "helpUrl": ""
        });
    }
};
...
// 10. 블록조립 종료시간 (정보 블록)
Blockly.Blocks['util_record_end_time'] = {
    init: function () {
        this.jsonInit({
            "type": "util_record_end_time",
            "message0": Blockly.Msg.BKY_UTIL_RECORD_END_TIME || "📊 블록조립 종료시간",
            "output": "String",
            "colour": "#08B89F",
            "tooltip": Blockly.Msg.BKY_UTIL_RECORD_END_TIME_TOOLTIP || "블록 조립을 종료한 시간을 반환합니다. 더블클릭하면 IDE 콘솔에 출력됩니다.",
            "helpUrl": ""
        });
    }
};
...
// 1. ESP32-CAM 선언부 블록
Blockly.Blocks['esp32cam_declare'] = {
    init: function () {
        this.jsonInit({
            "type": "esp32cam_declare",
            "message0": Blockly.Msg.BKY_ESP32CAM_DECLARE || "📷 ESP32-CAM 보드가 시작되었을 때",
            "nextStatement": null,
            "style": "event_blocks",
            "tooltip": Blockly.Msg.BKY_ESP32CAM_DECLARE_TOOLTIP || "ESP32-CAM 사용을 위한 라이브러리와 변수를 선언합니다.",
            "helpUrl": ""
        });
    }
};
...
// 2. WiFi 설정 블록
Blockly.Blocks['esp32cam_wifi_config'] = {
    init: function () {
        this.jsonInit({
            "type": "esp32cam_wifi_config",
            "message0": Blockly.Msg.BKY_ESP32CAM_WIFI_CONFIG || "📡 WiFi 설정 SSID %1 비밀번호 %2",
            "args0": [
                {
                    "type": "input_value",
                    "name": "SSID",
            ...
            "inputsInline": true,
            "colour": "#367E7F",
            "tooltip": Blockly.Msg.BKY_ESP32CAM_WIFI_CONFIG_TOOLTIP || "WiFi 연결을 위한 SSID와 비밀번호를 설정합니다.",
            "helpUrl": ""
        });
    }
};
...
// 3. 수신자 설정 블록
Blockly.Blocks['esp32cam_receiver_config'] = {
    init: function () {
        this.jsonInit({
            "type": "esp32cam_receiver_config",
            "message0": Blockly.Msg.BKY_ESP32CAM_RECEIVER_CONFIG || "📡 수신자 설정 IP %1 포트 %2 청크크기 %3",
            "args0": [
                {
                    "type": "input_value",
                    "name": "IP",
            ...
            "inputsInline": true,
            "colour": "#367E7F",
            "tooltip": Blockly.Msg.BKY_ESP32CAM_RECEIVER_CONFIG_TOOLTIP || "UDP 수신자의 IP, 포트, 청크 크기를 설정합니다.",
            "helpUrl": ""
        });
    }
};
...
// 4. 카메라 초기화 블록
Blockly.Blocks['esp32cam_setup'] = {
    init: function () {
        this.jsonInit({
            "type": "esp32cam_setup",
            "message0": Blockly.Msg.BKY_ESP32CAM_SETUP || "📷 카메라 초기화 프레임크기 %1 JPEG품질 %2 밝기 %3 대비 %4 채도 %5",
            "args0": [
                {
                    "type": "field_dropdown",
                    "name": "FRAME_SIZE",
            ...
            "inputsInline": true,
            "colour": "#367E7F",
            "tooltip": Blockly.Msg.BKY_ESP32CAM_SETUP_TOOLTIP || "WiFi에 연결하고 카메라를 초기화합니다. JPEG 품질은 10~63 (낮을수록 고품질), 밝기/대비/채도는 -2~2 범위입니다.",
            "helpUrl": ""
        });
    }
};
...
Blockly.Blocks['esp32cam_loop'] = {
    init: function () {
        this.jsonInit({
            "type": "esp32cam_loop",
            "message0": Blockly.Msg.BKY_ESP32CAM_LOOP || "📡 UDP로 영상 전송",
            "previousStatement": null,
            "nextStatement": null,
            "colour": "#367E7F",
            "tooltip": Blockly.Msg.BKY_ESP32CAM_LOOP_TOOLTIP || "카메라로부터 프레임을 캡처하고 UDP로 전송합니다.",
            "helpUrl": ""
        });
    }
};
...
Blockly.Blocks['esp32cam_led_control'] = {
    init: function () {
        this.jsonInit({
            "type": "esp32cam_led_control",
            "message0": Blockly.Msg.BKY_ESP32CAM_LED_CONTROL || "💡 ESP32-CAM LED %1",
            "args0": [
                {
                    "type": "field_dropdown",
                    "name": "STATE",
                    "options": [
                        [Blockly.Msg.BKY_ESP32CAM_LED_ON || "켜기", "HIGH"],
                        [Blockly.Msg.BKY_ESP32CAM_LED_OFF || "끄기", "LOW"]
                    ]
                }
            ],
            "previousStatement": null,
