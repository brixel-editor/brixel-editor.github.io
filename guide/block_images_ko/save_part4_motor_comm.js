// Part 4: MOTOR + COMMUNICATION (motor, output, communication, huskylens, webble, wifi, serial, esp32cam, tinyml)
// RUN: fetch("/guide/block_images_ko/save_part4_motor_comm.js").then(r=>r.text()).then(eval)

(async function savePart4() {
    "use strict";
    var CATS = ["motor","output","communication","huskylens","webble","wifi","serial","esp32cam","tinyml"];
    var SKIP_FLAGS = true;
    var FORMAT = "svg";
    ...
    console.log("=== Part 4: MOTOR + COMM (" + blockList.length + " blocks) ===");
    var ok = 0, fail = [];
    ...
    ws.clear();
    console.log("=== Part 4 DONE! " + ok + "/" + blockList.length + " ===");
