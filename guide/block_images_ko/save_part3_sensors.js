// Part 3: SENSORS (sensors_a, sensors_b)
// RUN: fetch("/guide/block_images_ko/save_part3_sensors.js").then(r=>r.text()).then(eval)

(async function savePart3() {
    "use strict";
    var CATS = ["sensors_a","sensors_b"];
    var SKIP_FLAGS = true;
    var FORMAT = "svg";
    ...
    console.log("=== Part 3: SENSORS (" + blockList.length + " blocks) ===");
    var ok = 0, fail = [];
    ...
    ws.clear();
    console.log("=== Part 3 DONE! " + ok + "/" + blockList.length + " ===");
