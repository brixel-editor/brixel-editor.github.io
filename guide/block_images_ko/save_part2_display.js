// Part 2: DISPLAY (display_a, display_b)
// RUN: fetch("/guide/block_images_ko/save_part2_display.js").then(r=>r.text()).then(eval)

(async function savePart2() {
    "use strict";
    var CATS = ["display_a","display_b"];
    var SKIP_FLAGS = true;
    var FORMAT = "svg";
    ...
    console.log("=== Part 2: DISPLAY (" + blockList.length + " blocks) ===");
    var ok = 0, fail = [];
    ...
    ws.clear();
    console.log("=== Part 2 DONE! " + ok + "/" + blockList.length + " ===");
