// Part 1: BASIC (main, pin, control, logic, math, text, color, variables, list, functions, utility)
// RUN: fetch("/guide/block_images_ko/save_part1_basic.js").then(r=>r.text()).then(eval)

(async function savePart1() {
    "use strict";
    var CATS = ["main","pin","control","logic","math","text","color","variables","list","functions","utility"];
    var SKIP_FLAGS = true;
    var FORMAT = "svg";
    ...
    console.log("=== Part 1: BASIC (" + blockList.length + " blocks) ===");
    var ok = 0, fail = [];
    ...
    ws.clear();
    console.log("=== Part 1 DONE! " + ok + "/" + blockList.length + " ===");
